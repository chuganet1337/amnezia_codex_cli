...
заранее устанавливать не нужно. Скрипт создаёт собственную управляемую копию в
...
Если первым показан `/opt/openai-codex/bin/codex`, текущая оболочка обходит
VPN-обёртку. Исправьте её и повторите проверку:
